...
export default {
  components: { AppHeader, MainContent, ShopContent, AppFooter1, AppFooter2 },
  data() {
    return {
      cards: [
        {
      ...
      ], // Passa l'array cards come prop al componente figlio
    };
  },
};
</script>
<template>
  <AppHeader /> <MainContent :cards="cards" />
  <ShopContent /><AppFooter1 /><AppFooter2 />
</template>
